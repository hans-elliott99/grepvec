...
When strings are compared by `grepvec`, they are first converted to UTF-8 (if needed).  

Inspired by the [R package cpp11.](https://cran.r-project.org/web/packages/cpp11/vignettes/motivations.html#utf-8-everywhere)
