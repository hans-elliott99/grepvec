...
I may add perl-compatible regular expressions through the PCRE library, but currently there is no `perl` option in `grepvec`.
...
R has support for different encodings, but this complicates things. See this statement from the [cpp11 R package](https://cran.r-project.org/web/packages/cpp11/vignettes/motivations.html#utf-8-everywhere).  
